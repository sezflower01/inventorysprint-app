-- READ-ONLY PROBE. Did the re-enrichment (requests 22277/22278) fix the fees
...
BEGIN
  ...
  FOR r IN SELECT id, status_code, left(content, 300) AS body FROM net._http_response WHERE id IN (22277, 22278) ORDER BY id LOOP
