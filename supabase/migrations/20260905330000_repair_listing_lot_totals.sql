-- REPAIR: created_listings.cost held the UNIT cost instead of the LOT TOTAL.
-- Approved by the seller 2026-09-05. Fixes 11 rows; B00K2U7A1U excluded.
-- (Staged first as scripts/repair-listing-lot-totals.sql.)
--
-- ---- WHAT IS WRONG -----------------------------------------------------
